...
public class MockNdefMessages {
    ...
    public static final byte[] URL_SLIDESHOW = new NewNdef("http://mobilesw.yonsei.ac.kr/library?service=slideshow&SessionID=hf").getNdef();
    
    /**
     * All the mock Ndef tags.
     */
    public static final byte[][] ALL_MOCK_MESSAGES =
        new byte[][] {SMART_POSTER_URL_NO_TEXT, ENGLISH_PLAIN_TEXT, SMART_POSTER_URL_AND_TEXT, URL_SLIDESHOW};
}
